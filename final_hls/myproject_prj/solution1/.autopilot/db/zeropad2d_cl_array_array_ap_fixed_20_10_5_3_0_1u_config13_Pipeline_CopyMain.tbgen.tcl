set moduleName zeropad2d_cl_array_array_ap_fixed_20_10_5_3_0_1u_config13_Pipeline_CopyMain
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_fixed<20,10,5,3,0>,1u>,config13>_Pipeline_CopyMain}
...
set Spec2ImplPortList { 
	mfcc_input { axis {  { mfcc_input_TVALID in_vld 0 1 }  { mfcc_input_TDATA in_data 0 32 }  { mfcc_input_TREADY in_acc 1 1 } } }
