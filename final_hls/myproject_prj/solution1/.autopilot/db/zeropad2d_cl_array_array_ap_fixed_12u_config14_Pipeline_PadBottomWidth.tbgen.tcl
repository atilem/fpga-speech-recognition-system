set moduleName zeropad2d_cl_array_array_ap_fixed_12u_config14_Pipeline_PadBottomWidth
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_fixed,12u>,config14>_Pipeline_PadBottomWidth}
