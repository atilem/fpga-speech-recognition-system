...
entity myproject_zeropad2d_cl_array_array_ap_fixed_12u_config14_Pipeline_PadBottomWidth is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_zeropad2d_cl_array_array_ap_fixed_12u_config14_Pipeline_PadBottomWidth is 
...
attribute shreg_extract : string;
    ...
    signal j_5_fu_34 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
    signal j_7_fu_60_p2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln77_fu_54_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    j_5_fu_34 <= j_7_fu_60_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_5_fu_34 <= ap_const_lv5_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    icmp_ln77_fu_54_p2 <= "1" when (ap_sig_allocacmp_j = ap_const_lv5_1B) else "0";
    j_7_fu_60_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv5_1));
