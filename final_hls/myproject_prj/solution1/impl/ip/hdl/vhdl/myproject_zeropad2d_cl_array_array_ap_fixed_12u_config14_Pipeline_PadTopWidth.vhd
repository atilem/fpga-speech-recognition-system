...
entity myproject_zeropad2d_cl_array_array_ap_fixed_12u_config14_Pipeline_PadTopWidth is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_zeropad2d_cl_array_array_ap_fixed_12u_config14_Pipeline_PadTopWidth is 
...
attribute shreg_extract : string;
    ...
    signal j_6_fu_60_p2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(layer14_out_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (layer14_out_full_n = ap_const_logic_0);
    end process;
    ...
    ap_sig_allocacmp_j_5_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, j_fu_34, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_j_5 <= ap_const_lv5_0;
        else 
            ap_sig_allocacmp_j_5 <= j_fu_34;
        end if; 
    end process;

    icmp_ln53_fu_54_p2 <= "1" when (ap_sig_allocacmp_j_5 = ap_const_lv5_1B) else "0";
    j_6_fu_60_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_5) + unsigned(ap_const_lv5_1));

    layer14_out_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, layer14_out_full_n, ap_block_pp0_stage0)
    begin
    ...
    layer14_out_din <= ap_const_lv216_lc_1;
    layer14_out_write <= layer14_out_write_local;

    layer14_out_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
